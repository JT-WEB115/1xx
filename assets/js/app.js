...
function init() {
    ...
    $.ajax({
        method: 'GET',
        url: 'http://me.jtdomain.com/wordpress/wp-json/wp-api-menus/v2/menus/2',
        dataType: 'json',
    ...
    $.ajax({
        method: 'GET',
        url: 'http://me.jtdomain.com/wordpress/wp-json/wp-api-menus/v2/menus/3?orderby=date&order=desc',
        dataType: 'json',
        success: function (data) {
